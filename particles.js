...
//  ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚══════╝  
    ...
    pJS.fn.particle = function (color, opacity, position) {
        ...
        this.tails = pJS.particles.move.tails;
        this.history = [];
...
//                                                                      
    pJS.fn.particlesUpdate = function () {
        ...
        for (var i = 0; i < pJS.particles.array.length; i++) {
            ...
            /* save previous location for tail */
            if (pJS.particles.move.tails > 0) {

                if (p.history.length >= p.tails) {
                    p.history.shift();
